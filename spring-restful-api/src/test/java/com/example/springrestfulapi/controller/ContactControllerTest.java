...
import com.example.springrestfulapi.model.ContactResponse;
import com.example.springrestfulapi.model.CreateContactRequest;
import com.example.springrestfulapi.model.UpdateContactRequest;
...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception{
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("Fathin");
        request.setLastName("Habiburrahman");
        request.setEmail("email@example.com");
        request.setPhone("082223905220");
        ...
        mockMvc.perform(
            ...
            assertEquals("Fathin", response.getData().getFirstName());
            assertEquals("Habiburrahman", response.getData().getLastName());
            assertEquals("email@example.com", response.getData().getEmail());
            assertEquals("082223905220", response.getData().getPhone());
    ...
    void getContactSuccess() throws Exception{
        ...
        contact.setFirstName("Fathin");
        contact.setLastName("Habiburrahman");
        contact.setEmail("email@example.com");
        contact.setPhone("082223905220");
    ...
    void deleteContactNotFound() throws Exception{
        mockMvc.perform(
                delete("/api/contacts/1234544643")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
