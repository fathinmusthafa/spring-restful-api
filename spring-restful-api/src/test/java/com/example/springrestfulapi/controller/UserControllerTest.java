...
import com.example.springrestfulapi.model.RegisterUserRequest;
import com.example.springrestfulapi.model.UpdateUserRequest;
import com.example.springrestfulapi.model.UserResponse;
...
class UserControllerTest {
    ...
    void updateUserSuccess() throws Exception {
        ...
        UpdateUserRequest request = new UpdateUserRequest();
        request.setName("Fathin");
        request.setPassword("Fathin123");
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("Fathin", response.getData().getName());
            assertEquals("test", response.getData().getUsername());

            User userDb = userRepository.findById("test").orElse(null);
            assertNotNull(userDb);
            assertTrue(BCrypt.checkpw("Fathin123", userDb.getPassword()));
